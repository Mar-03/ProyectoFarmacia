...
public class PanelLotesProductos extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        fondoVistaLotes.add(titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 850, -1));
        ...
        fondoVistaLotes.add(btnSalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 10, 40, 40));
        ...
        fondoVistaLotes.add(btnRegistrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 510, -1, 30));
        ...
        fondoVistaLotes.add(txtNombreUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 100, 160, -1));

        jLabel6.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel6.setText("Nombre Producto");
        fondoVistaLotes.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 110, 130, -1));
        ...
        fondoVistaLotes.add(btnBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 90, 110, 30));

        jLabel2.setText("Número Lote");
        fondoVistaLotes.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 260, -1, -1));

        txtNumeroLote.setBackground(new java.awt.Color(75, 128, 146));
        fondoVistaLotes.add(txtNumeroLote, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 260, 100, -1));

        jLabel3.setText("Fecha Vencimiento");
        fondoVistaLotes.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 260, -1, -1));

        txtFechaVencimiento.setBackground(new java.awt.Color(75, 128, 146));
        fondoVistaLotes.add(txtFechaVencimiento, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 250, 90, -1));

        jLabel4.setText("Cantidad");
        fondoVistaLotes.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 330, -1, -1));
        ...
        fondoVistaLotes.add(txtCantidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 320, -1, -1));

        jLabel5.setText("Precio Compra");
        fondoVistaLotes.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 370, -1, -1));
        ...
        fondoVistaLotes.add(txtPrecioCompra, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 360, -1, -1));

        jLabel8.setText("Precio Venta");
        fondoVistaLotes.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 420, -1, -1));

        txtPrecioVenta.setBackground(new java.awt.Color(75, 128, 146));
        fondoVistaLotes.add(txtPrecioVenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 410, -1, -1));
